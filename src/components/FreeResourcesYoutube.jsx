...
const FreeResourcesYoutube = () => {
    return (
        <section className="free-youtube-section">
            <div className="shell free-youtube-shell">
                <h2 className="free-section-heading">
                    {freeResourcesData.youtube.title}
                </h2>

                <div className="free-video-grid">
                    {freeResourcesData.youtube.videos.map((video) => (
...
export default FreeResourcesYoutube;
